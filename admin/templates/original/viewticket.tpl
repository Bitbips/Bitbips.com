...
<div class="ticketstaffnotes">
    ...
    <div>
        {$note.note}
        <div style="float:right;"><a href="clientsnotes.php?userid={$note.userid}&action=edit&id={$note.id}"><img src="images/edit.gif" width="16" height="16" align="absmiddle" /></a></div>
    </div>
</div>
{/foreach}
</div>
