...
$_ADMINLANG['general']['csrftoken.WHMCS.defaultinfo'] = "Cocher pour activer l'utilisation générale de tokens CSRF pour les fomulaires publics et de l'espace client (Hautement recommandé)";
$_ADMINLANG['general']['csrftoken.WHMCS.domainchecker'] = "CSRF Tokens: Vérification des domaines";
$_ADMINLANG['general']['csrftoken.WHMCS.domaincheckerinfo'] = "Cocher pour activer l'utilisation des tokens CSRF pour les formulaires de vérification des domaines";
...
$_ADMINLANG['sendmessage']['marketingemaildesc'] = "N'oubliez pas d'inclure le lien de désinscription pour être en accord avec la CAN-SPAM Act";
