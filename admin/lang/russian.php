...
$_ADMINLANG['domains']['leaveatzero'] = "Оставьте значение 0, чтобы запретить регистрацию. Чтобы запретить трансфер/продление - установите -1";
...
$_ADMINLANG['products']['upgradechargefullcycle'] = "Оплата за полный цикл";
$_ADMINLANG['products']['upgradechargefullcyclelabel'] = "Выберите для выставления счета за полный цикл при смене пакета";
...
$_ADMINLANG['automation']['firstrenewalinfo'] = "Укажите, за сколько дней до даты продления домена высылать первое напоминание";
$_ADMINLANG['automation']['secondrenewal'] = "Второе напоминание о продлении";
$_ADMINLANG['automation']['secondrenewalinfo'] = "Укажите, за сколько дней до даты продления домена высылать второе напоминание";
$_ADMINLANG['automation']['thirdrenewal'] = "Третье напоминание о продлении";
$_ADMINLANG['automation']['thirdrenewalinfo'] = "Укажите, за сколько дней до даты продления домена высылать третье напоминание";
$_ADMINLANG['automation']['fourthrenewal'] = "Четвертое напоминание о продлении";
$_ADMINLANG['automation']['fourthrenewalinfo'] = "Укажите, за сколько дней до даты продления домена высылать четвертое напоминание";
$_ADMINLANG['automation']['fifthrenewal'] = "Пятое напоминание о продлении";
$_ADMINLANG['automation']['fifthrenewalinfo'] = "Укажите, за сколько дней до даты продления домена высылать пятое напоминание";
...
$_ADMINLANG['system']['recepient'] = "Получатель";
...
$_ADMINLANG['general']['emailglobalheader'] = "Верхний колонтитул писем (Header)";
$_ADMINLANG['general']['emailglobalfooter'] = "Нижний колонтитул писем (Footer)";
...
$_ADMINLANG['general']['disablemd5'] = "Отключить MD5 клиентских паролей";
$_ADMINLANG['general']['disablemd5info'] = "Не рекомендуется, так как пароли могут быть дешифрованы (Отключение приведет к смене всех текущих паролей)";
...
$_ADMINLANG['general']['csrftoken.WHMCS.default'] = "CSRF токены: Главная";
$_ADMINLANG['general']['csrftoken.WHMCS.defaultinfo'] = "Нажмите сюда, чтобы включить токены во всех формах (Рекомендуется)";
$_ADMINLANG['general']['csrftoken.WHMCS.domainchecker'] = "CSRF токены: Проверка доменов";
$_ADMINLANG['general']['csrftoken.WHMCS.domaincheckerinfo'] = "Нажмите сюда, чтобы включить токены в проверке доменов";
