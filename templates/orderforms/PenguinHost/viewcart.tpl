...
<div class="signupfieldsextra">
    ...
    <div class="clearfix">
	    <label for="loginemail" style="float:left;">{$LANG.loginemail}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="loginpw" style="float:left;">{$LANG.loginpassword}</label>
		<div class="input">
...
<div class="signupfields">
    ...
    <div class="clearfix">
	    <label for="firstname" style="float:left;">{$LANG.clientareafirstname}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="lastname" style="float:left;">{$LANG.clientarealastname}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="companyname" style="float:left;">{$LANG.clientareacompanyname}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="email" style="float:left;">{$LANG.clientareaemail}</label>
		<div class="input">
...
{if !$loggedin}
    <div class="clearfix">
	    <label for="password" style="float:left;">{$LANG.clientareapassword}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="password2" style="float:left;">{$LANG.clientareaconfirmpassword}</label>
		<div class="input">
...
<div class="signupfields">
    ...
    <div class="clearfix">
	    <label for="address1" style="float:left;">{$LANG.clientareaaddress1}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="address2" style="float:left;">{$LANG.clientareaaddress2}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="city" style="float:left;">{$LANG.clientareacity}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="state" style="float:left;">{$LANG.clientareastate}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="postcode" style="float:left;">{$LANG.clientareapostcode}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="country" style="float:left;">{$LANG.clientareacountry}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="phonenumber" style="float:left;">{$LANG.clientareaphonenumber}</label>
		<div class="input">
...
{if $securityquestions && !$loggedin}
    <div class="clearfix">
	    <label for="securityqid" style="float:left;">{$LANG.clientareasecurityquestion}</label>
		<div class="input">
    ...
    <div class="clearfix">
	    <label for="securityqans" style="float:left;">{$LANG.clientareasecurityanswer}</label>
		<div class="input">
...
{foreach key=num item=customfield from=$customfields}
    <div class="clearfix">
	    <label for="customfield{$customfield.id}" style="float:left;margin-right:5px;">{$customfield.name}</label>
		<div class="input">
...
<p class="textcenter">{$LANG.carttaxupdateselections}<br /><br /> <input type="submit" value="{$LANG.carttaxupdateselectionsupdate}" name="updateonly" /></p>
{/if}
...
<div class="clear"></div>
  ...
  <div class="cartbox">{foreach key=num item=gateway from=$gateways}
    <label><input type="radio" name="paymentmethod" value="{$gateway.sysname}" onclick="{if $gateway.type eq "CC"}showCCForm(){else}hideCCForm(){/if}"{if $selectedgateway eq $gateway.sysname} checked{/if} /> &lt;img src=&quot;images/paymentmethod/{$gateway.sysname}.jpg&quot; alt=&quot;{$gateway.name}&quot; width=&quot;88&quot; height=&quot;31&quot; border=&quot;0&quot; align=&quot;absmiddle&quot;&gt;</label>
    {/foreach}</div>
